# -*- coding: utf-8 -*-
"""CC(Artical)Main.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Z-CBIi-1M2sx1G1y91mqXdcLwBlFSoeB
"""
...
print(os.getcwd())
base_dir = "/content/drive/MyDrive/Cervical Cancer Dataset/Medical Scan Classification Dataset/Cervical Cancer/Cervical Cancer"
categories = ["Dyskeratotic", "Koilocytotic", "Metaplastic",
              "Parabasal", "Superficial-Intermediat"]
...
for category in categories:
    category_path = os.path.join(dataset, category)a
...
print(f"NCC Classifications: {ncc_classifications}")
